...
$(DOCNAME).pdf: $(tex) meta.tex local.bib acronyms.tex RTN-053-summit.pdf RTN-053-USDF.pdf
	latexmk -bibtex -xelatex -f $(DOCNAME)
#	makeglossaries $(DOCNAME)
#	xelatex $(DOCNAME)
# For glossary uncomment the 2 lines above

RTN-053-summit.pdf : RTN-053-summit.ipynb
	jupyter nbconvert --to PDF RTN-053-summit.ipynb 
RTN-053-USDF.pdf : RTN-053-USDF.ipynb
	jupyter nbconvert --to PDF RTN-053-USDF.ipynb 
